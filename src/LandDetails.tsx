...
const LandDetails = () => {
  ...
  const handleCalcBuildingLicenseFee = (
    totalBuiltUp: number,
    wellOTHSump: number,
    compoundWall: number,
    wef: boolean,
    ...
    if (propType === "Residential") {
      ...
      if (totalBuiltUp > 400) {
        rate = 105 * db;
        newVar = totalBuiltUp - 400;
        totalBuiltUp -= newVar;
        feeValue += rate * newVar;
      }
      if (totalBuiltUp >= 101) {
        rate = 41 * db;
        newVar = totalBuiltUp - 100;
        totalBuiltUp -= newVar;
        feeValue += rate * newVar;
      }
      if (totalBuiltUp >= 41) {
        rate = 15.5 * db;
        newVar = totalBuiltUp - 40;
        totalBuiltUp -= newVar;
        feeValue += rate * newVar;
      }
      if (totalBuiltUp >= 0) {
        rate = 9 * db;
        feeValue += totalBuiltUp * rate;
      }
  ...
  const handleDemolitionFee = (
    groundFloor: number,
    groundFloorOther: number,
    firstFloor: number,
    wef: boolean
  ) => {
    let feeValue = 0,
  ...
  const handleTentativeCharges = (
    halfPlotFrontage: number,
    roadWidth: number
  ) => {
    let feeValue = 0,
      rate = 0;
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    result.buildingLicenseFee = handleCalcBuildingLicenseFee(
      formData.totalBuiltUp,
      formData.wellOTHSump,
      formData.compoundWall,
      formData.wef,
      formData.proposedType
    );
    result.demolitionFee = handleDemolitionFee(
      formData.existingTiled,
      formData.existingOther,
      formData.existingFirst,
      formData.wef
    );
    ...
    result.tentativeImprCharges = handleTentativeCharges(
      formData.proposedPlot / 2,
      formData.roadWidth
    );
    result.cmdaDevCharges = handleCMDADevCharges(
      formData.landUsage,
      formData.zoning,
      formData.plotExtent,
      formData.totalBuiltUp
      ...
      <form className="row g-3" onSubmit={handleSubmit}>
        ...
        <div className="col-md-6 d-flex">
          ...
          <div>
            ...
            />
            <label
              className="form-check-label space me-3"
            ...
            />
            <label
              className="form-check-label space"
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="plotextent" className="form-label me-3">
            <b>Plot Extent(Sq. Mt.)</b>
          </label>
          <input
            required
            name="plotExtent"
        ...
        <div className="col-md-12 d-flex">
          <label htmlFor="totalLand" className="form-label me-3">
            <b>Total Land Extent Prior to 05.08.1975</b>
          </label>
          <input
            required
            name="totalLand"
        ...
        <div className="col-md-12 d-flex align-items-center">
          <b className="me-3">
            Whether Regularisation Charges for Land Applicable?
          </b>
          <select
            name="whetherReg"
            onChange={handleChange}
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="width" className="form-label me-3">
            <b>Road Width (Mt.)</b>
          </label>
          <input
            required
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="total" className="form-label me-3">
            <b>Total FSI Area (Sq. Mt.)</b>
          </label>
          <input
            required
            name="totalFSI"
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="totalb" className="form-label ">
            <b>Total Built Up Area (Sq. Mt.)</b>
          </label>
          <input
            required
            name="totalBuiltUp"
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="propo" className="form-label me-3">
            <b>Proposed Plot Frontage (Mt.)</b>
          </label>
          <input
            required
            name="proposedPlot"
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="com" className="form-label me-3">
            <b>Compound Wall (R-M.)</b>
          </label>
          <input
            required
            name="compoundWall"
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="well" className="form-label me-3">
            <b>Well/OHT/Sump & Septic Tank Area (Sq. Mt.)</b>
          </label>
          <input
            required
            name="wellOTHSump"
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="ex" className="form-label me-3">
            <b>
              Existing Building Ground Floor Area (Tiled Floor Area) (Sq. Mt.)
            </b>
          </label>
          <input
            type="number"
        ...
        <div className="col-md-6 d-flex">
          <label htmlFor="exi" className="form-label me-3">
            <b>Existing Building Ground Floor Area (Other Types) (Sq. Mt.)</b>
          </label>
          <input
            type="number"
            name="existingOther"
        ...
        <div className="col-md-12 d-flex">
          <label htmlFor="exis" className="form-label me-3">
            <b>Existing Building First Floor and Above Total Area(Sq. Mt.)</b>
          </label>
          <input
            type="number"
            name="existingFirst"
        ...
        <div className="col-md-12 d-flex">
          <label htmlFor="buildingHeight" className="form-label me-3">
            <b>Building Height(Mt.)</b>
          </label>
          <input
            type="number"
            name="buildingHeight"
        ...
        <div className="col-md-12 d-flex">
          <label htmlFor="plinth" className="form-label me-3">
            <b>Plinth Area</b>
          </label>
          <input
            type="number"
        ...
        <div className="col-md-12 d-flex align-items-center">
          <b className="me-3">
            Whether Tentative improvement charges Applicable?
          </b>
          <select
            name="whetherTent"
            onChange={handleChange}
        ...
        <div className="col-md-12 d-flex align-items-center">
          <b className="me-3">
            Whether Regularisation Charges (penalty under section 244A) for
            Building Applicable?
          </b>
          <select
            name="whetherReg244"
